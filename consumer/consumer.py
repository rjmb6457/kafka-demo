...
# Consumer subscribes ONLY to the main transactions topic
...
def process_message(msg):
    # Validation: block high-value transactions unless flagged for reprocess
    ...
    for message in consumer:
        ...
        try:
            ...
            if record["retry"] >= 3:
                ...
                # Retry by resending to main topic
